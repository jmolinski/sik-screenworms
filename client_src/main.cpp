...
//-i gui_server – adres (IPv4 lub IPv6) lub nazwa serwera obsługującego interfejs użytkownika (domyślnie localhost) -r n – port serwera obsługującego interfejs użytkownika (domyślnie 20210)
